...
class SettingsManager:
    ...
    def get_groq_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            "endpoint": self.get("groq_api_endpoint", "https://api.groq.com/openai/v1/chat/completions")
        }
        
    def get_tavily_config(self) -> Dict[str, str]:
        """Get Tavily API configuration"""
        return {
            "api_key": self.get("tavily_api_key", "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")
        }
